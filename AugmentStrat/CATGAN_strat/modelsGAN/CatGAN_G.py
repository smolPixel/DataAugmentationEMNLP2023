...
from AugmentStrat.CATGAN_strat.modelsGAN.generator import LSTMGenerator
from AugmentStrat.CATGAN_strat.modelsGAN.relational_rnn_general import RelationalMemory
...
class CatGAN_G(LSTMGenerator):
    ...
    def forward(self, inp, hidden, label=None, need_hidden=False):
        ...
        # print(label)
        # print(label_onehot_ex.shape)
        # print(self.cat_mat.expand(inp.size(0), -1, -1).shape)
