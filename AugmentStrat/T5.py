...
class T5Paraphrase():
	...
	# def get_paraphrases(self, sentence, prefix="réecrit en français: ", n_predictions=1, top_k=10, max_length=50):
		bs=len(sentence)
	...
	def augment(self, train, dev, return_dict=False):
		...
		# train.return_pandas().to_csv(f'T5_train_{self.argdict["dataset"]}.tsv', sep='\t')
		# fds
		return train
